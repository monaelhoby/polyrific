window.onload = function () {
    ...
    Shuffle.options = {
      ...
      // group: element, // Initial filter group.
      ...
      itemSelector: '.shuffle-content', // e.g. '.picture-item'.
    ...
    Shuffle.ALL_ITEMS = 'dataScience';
    Shuffle.FILTER_ATTRIBUTE_KEY = 'groups';
    
    var shuffleInstance = new Shuffle(element, {
      itemSelector: '.shuffle-content',
    }); 

    shuffleInstance.filter(['dataScience', 'cloudComputing']);
